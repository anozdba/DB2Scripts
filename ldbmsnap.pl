...
# ldbmsnap.pl
#
# $Id: ldbmsnap.pl,v 1.4 2018/10/18 22:58:51 db2admin Exp db2admin $
#
# Description:
...
#
# Revision 1.3  2018/10/17 01:01:36  db2admin
...
my $ID = '$Id: ldbmsnap.pl,v 1.4 2018/10/18 22:58:51 db2admin Exp db2admin $';
my @V = split(/ /,$ID);
my $Version=$V[2];
my $Changed="$V[3] $V[4]";

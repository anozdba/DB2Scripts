...
# ldball.pl
#
# $Id: ldball.pl,v 1.7 2019/02/07 04:18:55 db2admin Exp db2admin $
#
# Description:
...
# ChangeLog:
# $Log: ldball.pl,v $
# Revision 1.7  2019/02/07 04:18:55  db2admin
...
my $ID = '$Id: ldball.pl,v 1.7 2019/02/07 04:18:55 db2admin Exp db2admin $';
my @V = split(/ /,$ID);
my $Version=$V[2];
my $Changed="$V[3] $V[4]";

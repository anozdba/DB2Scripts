...
# lnode.pl
#
# $Id: lnode.pl,v 1.10 2019/02/07 04:18:55 db2admin Exp db2admin $
#
# Description:
...
# ChangeLog:
# $Log: lnode.pl,v $
# Revision 1.10  2019/02/07 04:18:55  db2admin
# remove timeAdd from the use list as the module is no longer provided
#
# Revision 1.9  2019/01/25 03:12:41  db2admin
...
my $ID = '$Id: lnode.pl,v 1.10 2019/02/07 04:18:55 db2admin Exp db2admin $';
my @V = split(/ /,$ID);
my $Version=$V[2];
my $Changed="$V[3] $V[4]";
